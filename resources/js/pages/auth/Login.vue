      ...
      <div class="auth__card">
        ...
        >
          ...
          <div class="field">
            ...
            <InputError :message="errors.email" class="field__error" />
          </div>
          ...
          <div class="field">
            ...
            <InputError :message="errors.password" class="field__error" />
          </div>
        ...
        <!-- NOTE -->
        <p class="auth__note">
          Dengan masuk, Anda menyetujui tata tertib dan prosedur
          yang berlaku dalam penyelenggaraan Pemilos.
        </p>
