  ...
  <div class="page">
    ...
    <header class="nav">
      ...
      <Transition name="menu-fade">
        <div v-if="menuOpen" class="nav__menu">
          <div class="nav__menu-header">
            <span>Navigasi</span>
            <button type="button" class="nav__menu-close" aria-label="Tutup menu" @click="closeMenu">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round">
      ...
      <Transition name="overlay-fade">
        <button v-if="menuOpen" type="button" class="nav__overlay" aria-label="Tutup menu" @click="closeMenu"></button>
      </Transition>
    </header>
    ...
    <main class="done">
      ...
      <div class="done__inner">
        ...
        <div class="done__content" :class="{ 'is-visible': showContent }">
          ...
          <p class="done__desc">
            ...
            <br />
            Terima kasih telah berpartisipasi dalam pemilihan OSIS dan MPK.
          </p>
          ...
          <div class="done__actions">
            ...
            <a href="/hasil/osis" class="done__btn done__btn--secondary">
              Lihat Hasil OSIS
              <span>→</span>
            </a>

            <a href="/hasil/mpk" class="done__btn done__btn--secondary">
              Lihat Hasil MPK
              <span>→</span>
            </a>
          ...
          <p class="done__note">
            Suaramu adalah masa depan sekolah. Terima kasih sudah berpartisipasi.
          </p>
