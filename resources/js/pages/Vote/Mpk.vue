...
const misiList = computed(() => {
    if (!selectedGroup.value?.misi) return [];
    return selectedGroup.value.misi
        .split('\n')
        .map((line) => line.trim())
    ...
    ====================================================== -->
        ...
        ================================================== -->
                ...
                <div class="vote__meta">
                    ...
                    <span class="vote__year"> Pemilos 2026/2027 </span>
                </div>
        ...
        ================================================== -->
                ...
                <template v-if="!selectedGroup">
                    <section class="vote__heading">
                        ...
                        <p class="vote__desc">
                            Kenali setiap pasangan calon sebelum menentukan satu
                            suara. Pilihanmu akan dicatat sebagai suara yang sah
                    ...
                    <div class="vote__notice">
                        ...
                        <div>
                            <strong> Pilih dengan cermat. </strong>
                        ...
                        >
                            <div class="candidate-card__top">
                                ...
                                <span class="candidate-card__number">
                                    {{
                                        String(group.nomor_urut).padStart(
                                            2,
                                            '0',
                                        )
                                    }}
                ...
                <template v-else>
                    <section class="detail">
                        ...
                        <section class="detail__section">
                            ...
                            <div class="detail__section-content">
                                <ul v-if="misiList.length" class="misi-list">
            ...
            <div v-if="showConfirm" class="modal" @click.self="closeConfirm">
                <div class="modal__card">
                    <div class="modal__top">
                        <span class="modal__eyebrow"> Konfirmasi pilihan </span>
                    ...
                    <div class="modal__body">
                        <div class="modal__number">
                            {{
                                String(selectedGroup.nomor_urut).padStart(
                                    2,
                                    '0',
                                )
                            }}
                        ...
                        <p class="modal__question">Kamu akan memilih:</p>
...
.candidate-card:hover {
    ...
    box-shadow: 0 18px 38px rgba(24, 23, 22, 0.08);
}
...
/* ---- FOTO KANDIDAT (list) — diperbesar 2x ---- */
...
/* ---- FOTO KANDIDAT (detail) — diperbesar 2x ---- */
