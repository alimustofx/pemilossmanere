    ...
    <main class="announcement-page">
      ...
      <div class="announcement-page__inner">
        ...
        <section class="announcement-page__heading">
          <p class="announcement-page__eyebrow">
            Informasi Resmi
          </p>
        ...
        <section class="announcement-list">
          ...
          <!-- KOSONG -->
          <div v-if="!announcements.length" class="announcement-empty">
            <span class="announcement-empty__icon">📢</span>
            <h3>Belum ada pengumuman</h3>
            <p>Pengumuman resmi akan muncul di sini setelah diterbitkan oleh panitia.</p>
          </div>
          ...
          >
            ...
            <!-- KONTEN -->
            <div class="announcement-card__body" :class="{ 'announcement-card__body--no-image': !a.image }">
