      ...
      <div class="result__inner">
        ...
        <section class="result__stats">
          ...
          <div class="stat-card">
            ...
            <span class="stat-card__number">{{ candidateCount }}</span>
          </div>
          <div class="stat-card stat-card--empty">
            <span class="stat-card__label">Status</span>
            <span class="stat-card__number stat-card__number--small">
          ...
          >
            <div class="result-bar__header">
              <span class="result-bar__number">
                {{ String(r.candidate_group?.nomor_urut || '—').padStart(2, '0') }}
              </span>
              <span class="result-bar__name">
                {{ r.candidate_group?.nama_kelompok || 'Tidak diketahui' }}
              </span>
              <span class="result-bar__votes">
                {{ r.total }} suara
              </span>
              <span class="result-bar__percent">
                {{ totalVotes > 0 ? Math.round((r.total / totalVotes) * 100) : 0 }}%
              </span>
            </div>
            ...
            <div class="result-bar__track">
              <div
                ...
                :style="{
                  width: totalVotes > 0 ? `${(r.total / totalVotes) * 100}%` : '0%',
                }"
              >
        ...
        <div class="result__actions">
          ...
          <div class="result__btn-group">
            <button
              ...
              @click="goToOsis"
              :class="{ 'result__btn--active': election.type === 'osis' }"
            >
              Hasil OSIS
            </button>
            ...
            <button
              ...
              class="result__btn result__btn--outline"
              @click="goToMpk"
              :class="{ 'result__btn--active': election.type === 'mpk' }"
            >
              Hasil MPK
            </button>
          </div>
...
.result-bar__fill {
  ...
  transition:
    width 800ms cubic-bezier(.22, 1, .36, 1);
