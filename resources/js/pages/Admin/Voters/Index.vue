  ...
  <div class="voters">
    ...
    <header class="voters__header">
      <div class="voters__header-left">
        ...
        <h1 class="voters__title">
          Manajemen <em>Pemilih.</em>
        </h1>
      ...
      <div class="voters__header-right">
        <a href="/admin/voters/export" class="voters__export">
          <span class="voters__export-icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><path d="M7 10l5 5 5-5" /><path d="M12 15V3" /></svg>
          </span>
    ...
    <section class="import">
      <div class="import__head">
        <div>
          ...
          <h2 class="import__title">
            Unggah <em>CSV</em> Pemilih
          </h2>
        </div>
      ...
      >
        <label class="import__drop">
          ...
          <span class="import__drop-icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><path d="M17 8l-5-5-5 5" /><path d="M12 3v12" /></svg>
          </span>

          <span class="import__drop-label">
            {{ form.file ? form.file.name : 'Pilih file CSV atau klik untuk memilih' }}
          </span>
        </label>
    ...
    <section class="table">
      ...
      <div class="table__head">
        ...
        <div class="table__stats">
          ...
          <div class="table__stat">
            ...
            <span class="table__stat-value table__stat-value--accent">
      ...
      >
        ...
        <h3 class="table__empty-title">Belum ada pemilih</h3>
          ...
          <tbody>
            ...
            >
              <td class="table__td table__td--num">
                {{ String((currentPage - 1) * (voters.per_page ?? 15) + index + 1).padStart(3, '0') }}
              </td>
              ...
              <td class="table__td table__td--center">
                <span
                  class="vote-pill"
                  :class="voter.osis_voted_at ? 'vote-pill--done' : 'vote-pill--pending'"
                >
                  {{ voter.osis_voted_at ? '✓' : '—' }}
                </span>
              </td>
              <td class="table__td table__td--center">
                <span
                  class="vote-pill"
                  :class="voter.mpk_voted_at ? 'vote-pill--done' : 'vote-pill--pending'"
                >
                  {{ voter.mpk_voted_at ? '✓' : '—' }}
                </span>
              </td>
              <td class="table__td">
                <span
                  class="status-pill"
                  :class="voter.status ? 'status-pill--active' : 'status-pill--inactive'"
                >
              ...
              <td class="table__td table__td--right">
                <div class="table__actions">
                  ...
                  >
                    {{ voter.status ? 'Nonaktifkan' : 'Aktifkan' }}
                  </button>
...
/* =========================================================
   ...
   (versi bersih, tanpa trik background-shadow yang rawan bug)
========================================================= */
