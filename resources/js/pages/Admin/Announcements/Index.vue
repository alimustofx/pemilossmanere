...
function submit() {
    if (editing.value) {
        form.transform((d) => ({ ...d, _method: 'post' })).post(
            `/admin/announcements/${editing.value.id}`,
            {
                forceFormData: true,
...
<template>
        ...
        <header class="announcements__header">
            ...
            <div class="announcements__header-right">
                ...
                >
                    ...
                    <span class="announcements__create-label"
                        >Tambah Pengumuman</span
                    >
                </button>
            </div>
        </header>
    ...
    ====================================================== -->
        ...
        <div v-if="$page.props.flash?.success" class="announcements__flash">
    ...
    ====================================================== -->
        ...
        <div v-if="!announcements?.length" class="announcements__empty">
            ...
            <p class="announcements__empty-text">
                Tambahkan pengumuman pertama untuk dipublikasikan kepada seluruh
                pemilih.
            </p>
            <button
                type="button"
                        ...
                        <div class="field">
                            ...
                            <div class="field__options">
                                ...
                                >
                                    ...
                                    />
                                    <span
                                        class="field__option-dot field__option-dot--draft"
                                    ></span>
                                    <span class="field__option-text"
                                        >Draft</span
                                    >
                                    <span class="field__option-desc"
                                ...
                                >
                                    ...
                                    />
                                    <span
                                        class="field__option-dot field__option-dot--published"
                                    ></span>
                                    <span class="field__option-text"
                                        >Published</span
                                    >
                                    <span class="field__option-desc"
                                        >Tampil di halaman publik</span
                                    >
                                </label>
                            </div>
                        </div>
