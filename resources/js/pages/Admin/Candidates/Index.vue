...
function openEdit(group) {
  ...
  form.programs = group.programs.length
    ? group.programs.map((p) => ({ title: p.title, description: p.description }))
    : [{ title: '', description: '' }]
...
function submit() {
  if (editingGroup.value) {
    form
      ...
      .post(`/admin/candidates/${editingGroup.value.id}`, {
        forceFormData: true,
  ...
  <div class="candidates">
    ...
    <header class="candidates__header">
      <div class="candidates__header-left">
        ...
        <h1 class="candidates__title">
          Manajemen <em>Kandidat.</em>
        </h1>
      ...
      <div class="candidates__header-right">
        ...
        >
          ...
          <span class="candidates__create-label">Tambah Kandidat</span>
        </button>
      </div>
    </header>
        ...
        >
          ...
          <div class="modal__top">
            <span class="modal__eyebrow">
              {{ editingGroup ? 'Edit Kandidat' : 'Tambah Kandidat' }}
            </span>
          ...
          <div class="modal__body">
            ...
            <div class="field-row">
              ...
              <div v-if="!editingGroup" class="field">
                ...
                <select v-model="form.model" class="field__input">
            ...
            <div class="field">
              ...
              <input
                type="file"
                class="field__file"
                @change="(e) => (form.ketua_photo = e.target.files[0])"
              />
            </div>
            ...
            <div v-if="form.model === 'pair'" class="field">
              ...
              <input
                type="file"
                class="field__file"
                @change="(e) => (form.wakil_photo = e.target.files[0])"
              />
            </div>
            ...
            <div class="field">
              <div class="field__row">
                <label class="field__label">Program Unggulan</label>
          ...
          <div class="modal__actions">
            ...
            >
              <span>
                {{ form.processing ? 'Menyimpan...' : 'Simpan Kandidat' }}
              </span>
