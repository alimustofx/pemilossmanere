  ...
  <div class="admin">
    ...
    <header class="admin__header">
      ...
      <div class="admin__header-right">
        <a
          href="/admin/dashboard/export-results"
          class="admin__export"
        >
    ...
    <section class="stats">
      <div class="stats__grid">
        ...
        <div class="stat-card">
          ...
          <span class="stat-card__number">{{ stats.total_voters }}</span>
        ...
        <div class="stat-card">
          ...
          <span class="stat-card__number">{{ stats.belum_memilih }}</span>
        ...
        <div class="stat-card stat-card--participation">
          ...
          <div class="stat-card__bar">
            <div
              ...
              :style="{ width: `${Math.min(stats.participation, 100)}%` }"
            ></div>
          </div>
        </div>
          ...
          >
            <div class="result-bar__header">
              <span class="result-bar__name">
                {{ result.candidate_group?.nama_kelompok ?? 'Tidak diketahui' }}
              </span>
    ...
    <p class="admin__note">
      Data diperbarui secara otomatis. Halaman ini hanya dapat
      diakses oleh panitia dan administrator pemilihan.
    </p>
